...
date: "<br>DES Workshop, July 1 2023"
output:
...
knitr::include_graphics("../images/figure-html/tools-spectrum-1.png")
```
]
]
...
```
```{r 202306_cites, echo=FALSE, fig.asp=0.85}
library(ggplot2)

cites$healthcare <- c(0, 0, 2, 3, 9, 5, 0)
cites <- cites |>
