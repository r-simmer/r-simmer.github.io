...
\usepackage{amsmath} \usepackage{longtable} \usepackage{booktabs} \usepackage{subfig} \providecommand{\pandocbounded}[1]{#1}
...
This manuscript corresponds to \pkg{simmer} version 4.4.7 and was
typeset on September 28, 2024. For citations, please use the JSS version
...
{\centering \includegraphics[width=0.8\linewidth]{includes/jss-job-shop} 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{includes/jss-simmer-design.pdf}}
...
{\centering \subfloat[Instantaneous usage.\label{fig:mm1-plot-1}]{\includegraphics[width=.49\linewidth]{/home/iucar/Documents/repos/simmer/docs/articles/simmer-02-jss_files/figure-latex/mm1-plot-1} }\subfloat[Convergence over time.\label{fig:mm1-plot-2}]{\includegraphics[width=.49\linewidth]{/home/iucar/Documents/repos/simmer/docs/articles/simmer-02-jss_files/figure-latex/mm1-plot-2} }
...
{\centering \subfloat[Boxplots for 20 runs of the M/M/1 test with \code{n=1e4}.\label{performance-mm1-init}\label{fig:performance-mm1-plot-1}]{\includegraphics[width=.49\linewidth]{includes/jss-benchmark-boxplot} }\subfloat[Performance evolution with the batch size $m$.\label{performance-mm1-plot}\label{fig:performance-mm1-plot-2}]{\includegraphics[width=.49\linewidth]{includes/jss-benchmark-batched} }
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4265}}
